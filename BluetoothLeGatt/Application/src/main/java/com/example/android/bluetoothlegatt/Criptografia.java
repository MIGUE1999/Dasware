...
public class Criptografia {
    ...
    public void generateNonce(){
        ...
        Log.d(TAG, "Nonce Creado, es: "+ BluetoothLeService.bytesToHex(nonc));
        nonce= nonc;
    ...
    public byte[] diffieHellman(byte[] peripheralPubKey){
        ...
        if(Sodium.crypto_scalarmult_curve25519(dhk,shared_key ,peripheralPubKey) != 0){
        ...
        Log.d(TAG, "El valor de la shared key es: "+ BluetoothLeService.bytesToHex(shared_key));
        Log.d(TAG, "El valor del dhk es: "+  BluetoothLeService.bytesToHex(dhk));
        return shared_key;
    }
